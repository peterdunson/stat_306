...
# Checking that I have a probability distribution
...
# Here is the Gibbs Discrete Algorithm
...
simprobs <- data.frame(my_gibbs_discrete(p,i=1,10000))
simprobs
names(simprobs) <- c("X","Y")
simprobs
table(simprobs)/10000
